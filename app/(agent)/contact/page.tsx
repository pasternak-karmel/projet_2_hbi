        ...
        <div className="flex flex-col items-center">
          ...
          {showMessageBox && (
            <div className="w-full max-w-lg bg-white p-8 rounded-xl shadow-2xl transform transition-all duration-300 scale-105">
              <h2 className="text-3xl font-semibold mb-6 text-center text-teal-600">
                Envoyer un Message
              </h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    <option value="Problème de livraison">
                      Problème de livraison
                    </option>
                    <option value="Retard de livraison">
                      Retard de livraison
                    </option>
                    <option value="Changement de trajet">
                      Changement de trajet
                    </option>
                    <option value="Demande de congé">Demande de congé</option>
                    <option value="Problème avec le véhicule">
