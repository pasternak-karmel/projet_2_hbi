            ...
            <div className="col-lg-10">
              <div className="row align-items-center">
                <div className="col-md-5 col-sm-12 mb-30 text-center text-md-start">
                  <img src="assets/imgs/page/404/404.png" alt="TechSeed" />
                </div>
      ...
      <div className="section bg-grey-80 pt-70 pb-70">
        <div className="container">
          <ul className="list-partners">
            <li>
              <img src="assets/imgs/page/homepage1/placed.png" alt="TechSeed" />
            </li>
            <li>
              <img src="assets/imgs/page/homepage1/cuebiq.png" alt="TechSeed" />
            </li>
            <li>
              <img
            ...
            <li>
              <img src="assets/imgs/page/homepage1/spen.png" alt="TechSeed" />
            </li>
            <li>
              <img src="assets/imgs/page/homepage1/klippa.png" alt="TechSeed" />
            </li>
            <li>
              <img src="assets/imgs/page/homepage1/matrix.png" alt="TechSeed" />
            </li>
          </ul>
        </div>
      </div>
          ...
          <div className="box-newsletter box-newsletter-2">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-7 m-auto text-center">
                ...
                <p className="font-md color-grey-500">
                  Do not miss the information from us about the trending in the
                  market. By clicking the button, you are agreeing with our Term
                  &amp; Conditions
                </p>
